...
def connect_to_server(name):
    ...
    try:
        ...
        # CHANGE - encode all sent messages as bytes
        ...
        tk.messagebox.showerror(title="ERROR!!!", message="Cannot connect to host: " + "0.0.0.0" + " on port: " + str(
            8080) + " Server may be Unavailable. Try again later")
...
def receive_message_from_server(sck, m):
    ...
    while True:
        ...
        # CHANGE - decode all received messages to string
