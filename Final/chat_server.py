...
# ==============================================================================    
            ...
            elif msg["action"]=='face recognition':
                import GUI_Computer_Vision
                from_name = self.logged_sock2name[from_sock]
                vision = GUI_Computer_Vision.Vision()
                mysend(from_sock, json.dumps(
                    {"action": "list", "results": vision}))
            
# =============================================================================
#             elif msg["action"]=='linear regression':
#                 import linear_regression
#                 from_name = self.logged_sock2name[from_sock]
#                 
#                 linear_regression_object = linear_regression.Predict()
#                # mysend(from_sock, json.dumps(
#                #    {"action": "list", "results": linear_regression_object}))
# =============================================================================
                
            elif msg["action"]=='tic-tac-toe':
                import tic_tac_toe
                from_name = self.logged_sock2name[from_sock]
                tic_tac_toe_game = tic_tac_toe.Tic_Tac_Toe()
                mysend(from_sock, json.dumps(
                    {"action": "list", "results": tic_tac_toe_game}))
